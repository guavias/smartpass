...
<<<<<<< HEAD
} from "./chunk-CFPYF2ZO.js";
=======
} from "./chunk-TH5AZFLP.js";
import {
  Fade_default,
  IconButton_default,
  Typography_default,
...
import {
  ...
  useForkRef
<<<<<<< HEAD
} from "./chunk-XCOMDFRA.js";
import "./chunk-6ZTKJVT4.js";
import "./chunk-XCFLKDTG.js";
=======
} from "./chunk-RWFV6NPQ.js";
import "./chunk-O4WR3DXW.js";
>>>>>>> origin/Emily
import {
  ...
  useThemeProps
<<<<<<< HEAD
} from "./chunk-RQCNVLKN.js";
=======
} from "./chunk-Q3ELAL7H.js";
>>>>>>> origin/Emily
import {
  require_jsx_runtime
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React7.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React11.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React11.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
  ...
  return (0, import_jsx_runtime3.jsxs)(PickersCalendarDayRoot, {
    ...
    children: [(0, import_jsx_runtime3.jsxs)(PickersCalendarDayHeader, {
      ...
      }), getWeekdays(adapter, now).map((weekday, i) => (0, import_jsx_runtime3.jsx)(PickersCalendarWeekDayLabel, {
        variant: "caption",
        role: "columnheader",
...
var MonthCalendarButton = React12.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime4.jsx)(MonthButton, _extends({}, monthButtonProps));
});
...
var useControlledValue = ({
  ...
  const inputTimezone = React13.useMemo(() => valueManager.getTimezone(adapter, valueWithInputTimezone), [adapter, valueManager, valueWithInputTimezone]);
  ...
  const timezoneToRender = React13.useMemo(() => {
    if (timezoneProp) {
      return timezoneProp;
    }
    if (inputTimezone) {
  ...
  const valueWithTimezoneToRender = React13.useMemo(() => valueManager.setTimezone(adapter, timezoneToRender, valueWithInputTimezone), [valueManager, adapter, timezoneToRender, valueWithInputTimezone]);
...
var _excluded6 = ["autoFocus", "className", "currentMonth", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var MonthCalendar = React15.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React15.useMemo(() => adapter.getMonth(now), [adapter, now]);
  const selectedMonth = React15.useMemo(() => {
    if (value != null) {
      return adapter.getMonth(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedMonth, setFocusedMonth] = React15.useState(() => selectedMonth || adapter.getMonth(referenceDate));
  ...
  const isMonthDisabled = React15.useCallback((dateToValidate) => {
  ...
  return (0, import_jsx_runtime5.jsx)(MonthCalendarRoot, _extends({
    ...
    children: getMonthsInYear(adapter, currentMonth ?? value ?? referenceDate).map((month) => {
      ...
      return (0, import_jsx_runtime5.jsx)(MonthCalendarButton, {
        selected: isSelected,
        value: monthNumber,
...
var YearCalendarButton = React16.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
  ...
  return (0, import_jsx_runtime6.jsx)(YearButton, _extends({}, yearButtonProps));
});
...
var YearCalendar = React17.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React17.useMemo(() => adapter.getYear(now), [adapter, now]);
  const selectedYear = React17.useMemo(() => {
    if (value != null) {
      return adapter.getYear(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedYear, setFocusedYear] = React17.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React17.useCallback((dateToValidate) => {
  ...
  return (0, import_jsx_runtime7.jsxs)(YearCalendarRoot, _extends({
    ref: handleRef,
    className: clsx_default(classes.root, className),
    ownerState,
    role: "radiogroup",
    ...
    children: [yearRange.map((year) => {
      ...
      return (0, import_jsx_runtime7.jsx)(YearCalendarButton, {
        selected: isSelected,
        value: yearNumber,
      ...
      length: fillerAmount
    }, (_, index) => (0, import_jsx_runtime7.jsx)(YearCalendarButtonFiller, {}, index))]
  }));
});
...
var ArrowDropDownIcon = createSvgIcon((0, import_jsx_runtime8.jsx)("path", {
  d: "M7 10l5 5 5-5z"
}), "ArrowDropDown");
var ArrowLeftIcon = createSvgIcon((0, import_jsx_runtime8.jsx)("path", {
  d: "M15.41 16.59L10.83 12l4.58-4.59L14 6l-6 6 6 6 1.41-1.41z"
}), "ArrowLeft");
var ArrowRightIcon = createSvgIcon((0, import_jsx_runtime8.jsx)("path", {
  d: "M8.59 16.59L13.17 12 8.59 7.41 10 6l6 6-6 6-1.41-1.41z"
}), "ArrowRight");
var CalendarIcon = createSvgIcon((0, import_jsx_runtime8.jsx)("path", {
  d: "M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z"
}), "Calendar");
var ClockIcon = createSvgIcon((0, import_jsx_runtime8.jsxs)(React19.Fragment, {
...
var DateRangeIcon = createSvgIcon((0, import_jsx_runtime8.jsx)("path", {
  d: "M9 11H7v2h2v-2zm4 0h-2v2h2v-2zm4 0h-2v2h2v-2zm2-7h-1V2h-2v2H8V2H6v2H5c-1.11 0-1.99.9-1.99 2L3 20c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 16H5V9h14v11z"
}), "DateRange");
var TimeIcon = createSvgIcon((0, import_jsx_runtime8.jsxs)(React19.Fragment, {
  children: [(0, import_jsx_runtime8.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime8.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var ClearIcon = createSvgIcon((0, import_jsx_runtime8.jsx)("path", {
...
var _excluded9 = ["children", "className", "slots", "slotProps", "isNextDisabled", "isNextHidden", "onGoToNext", "nextLabel", "isPreviousDisabled", "isPreviousHidden", "onGoToPrevious", "previousLabel", "labelId", "classes"];
